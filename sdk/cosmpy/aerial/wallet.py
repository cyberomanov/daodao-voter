...
from sdk.cosmpy.crypto.keypairs import PrivateKey, PublicKey
from sdk.cosmpy.mnemonic import COSMOS_HD_PATH, derive_child_key_from_mnemonic
...
class LocalWallet(Wallet):
    ...
    def from_mnemonic(mnemonic: str, prefix: Optional[str] = None) -> "LocalWallet":
        ...
        private_key = PrivateKey(child_key)
        local_wallet = LocalWallet(private_key, prefix=prefix)
        return local_wallet
