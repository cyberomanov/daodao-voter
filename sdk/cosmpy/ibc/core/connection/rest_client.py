...
from sdk.cosmpy.ibc.core.connection.interface import IBCCoreConnection  # type: ignore
from sdk.cosmpy.osmosis_protobuf.ibc.core.connection.v1.query_pb2 import (
